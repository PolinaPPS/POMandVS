...
public interface FlickrAPI {
    @GET("services/rest/?method=flickr.photos.getRecent&api_key=eb33ee1959aca46f8dbc2fa8a56f9f24&extras=url_s&per_page=10&page=1&format=json&nojsoncallback=1")
